...
CAMERA_KEYS = [
    ...
    (0.40, (-2.9, -1.4, 3.9), (0.3, 8.4, -0.9), 26, "cab"),        # over the operator's shoulder
    (0.52, (-2.85, -1.2, 3.95), (0.3, 8.2, -1.3), 26, "cab"),
    (0.62, (5.0, 1.2, 17.5), (1.6, 6.2, -1.2), 30, "world"),       # overhead of the pit
    (0.76, (3.4, 3.4, 19.0), (1.2, 6.6, -1.6), 30, "world"),
    (0.86, (-2.2, 10.2, 1.0), (0.4, 2.6, 0.4), 24, "world"),       # low across the water
    (1.00, (-2.6, 9.9, 0.2), (0.3, 3.0, 0.6), 24, "world"),
]
